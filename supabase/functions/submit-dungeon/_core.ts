...
var REGIONAL_BLANK_ID = /^eq_r\d+_[a-z]+_[a-z]+$/;
function selectStrongestDefinition(slot, anchorLevel) {
  ...
  if (!best) {
    throw new Error(
      `[\u914D\u7F6E\u9519\u8BEF] \u90E8\u4F4D ${slot} \u5728\u951A\u70B9 Lv${anchorLevel} \u627E\u4E0D\u5230\u4EFB\u4F55\u4E0D\u8D85\u6A21\u7684\u4E3B\u7EBF\u80DA\u5B50\u5B9A\u4E49 \u2014\u2014 \u6700\u4F4E\u54C1\u8D28\u7684\u533A\u57DF\u88C5\u5907\u4E5F\u9AD8\u4E8E\u8BE5\u7B49\u7EA7\u7684\u4E3B\u7EBF\u5178\u578B\uFF08docs/66 \xA73.5\uFF09`
    );
  }
  return best.id;
}
...
function expectedGearStatsFromDefinitions(level) {
