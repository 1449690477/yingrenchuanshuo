...
begin
  select result into v_result from public.guild_submission_requests
  ...
  where guild_id = v_guild_id and week_key = p_week_key and day_key = p_day_key and user_id = p_user_id;
  insert into public.guild_submission_requests(request_id, user_id, guild_id, week_key, day_key, result)
  values (p_request_id, p_user_id, v_guild_id, p_week_key, p_day_key, v_result);
  return v_result;
end;
$$;
