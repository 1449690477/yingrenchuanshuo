 ...
 */
export const REGION_8_LOOT_PROFILE: RegionLootProfile = {
  qualityWeights: {
    normal: { epic: 0.7, legendary: 0.03 },
    elite: { epic: 8, legendary: 0.12, mythic: 0.02 },
    boss: { epic: 12, legendary: 0.15, mythic: 0.06 },
  },
  bossQualityPity: {
    quality: 'mythic',
    groupId: 'r8-mythic',
