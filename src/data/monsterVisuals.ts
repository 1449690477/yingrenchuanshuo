...
export const MONSTER_VISUALS: Readonly<Record<string, MonsterVisual>> = {
  ...
  'mon_2-1_0': { asset: 'assets/monsters/r2/mon_2-1_0.png' },
  'mon_2-1_1': { asset: 'assets/monsters/r2/mon_2-1_1.png' },
  'mon_2-1_2': { asset: 'assets/monsters/r2/mon_2-1_2.png' },
  'mon_2-1_3': { asset: 'assets/monsters/r2/mon_2-1_3.png' },
  'mon_2-2_0': { asset: 'assets/monsters/r2/mon_2-2_0.png' },
  'mon_2-2_1': { asset: 'assets/monsters/r2/mon_2-2_1.png' },
  'mon_2-2_2': { asset: 'assets/monsters/r2/mon_2-2_2.png' },
  'mon_2-2_3': { asset: 'assets/monsters/r2/mon_2-2_3.png' },
  'mon_2-2_elite': { asset: 'assets/monsters/r2/mon_2-2_elite.png' },
  'mon_2-3_0': { asset: 'assets/monsters/r2/mon_2-3_0.png' },
  'mon_2-3_1': { asset: 'assets/monsters/r2/mon_2-3_1.png' },
  'mon_2-3_2': { asset: 'assets/monsters/r2/mon_2-3_2.png' },
  'mon_2-3_3': { asset: 'assets/monsters/r2/mon_2-3_3.png' },
  'mon_2-3_elite': { asset: 'assets/monsters/r2/mon_2-3_elite.png' },
  'mon_2-4_0': { asset: 'assets/monsters/r2/mon_2-4_0.png' },
  'mon_2-4_1': { asset: 'assets/monsters/r2/mon_2-4_1.png' },
  'mon_2-4_2': { asset: 'assets/monsters/r2/mon_2-4_2.png' },
  'mon_2-4_3': { asset: 'assets/monsters/r2/mon_2-4_3.png' },
  'mon_2-4_elite': { asset: 'assets/monsters/r2/mon_2-4_elite.png' },
  'mon_2-5_0': { asset: 'assets/monsters/r2/mon_2-5_0.png' },
  'mon_2-5_1': { asset: 'assets/monsters/r2/mon_2-5_1.png' },
  'mon_2-5_2': { asset: 'assets/monsters/r2/mon_2-5_2.png' },
  'mon_2-5_3': { asset: 'assets/monsters/r2/mon_2-5_3.png' },
  'mon_2-5_elite': { asset: 'assets/monsters/r2/mon_2-5_elite.png' },
  'mon_2-5_boss': { asset: 'assets/monsters/r2/mon_2-5_boss.png' },
};
