 ...
 *
 * 上限从哪来：战斗硬上限 90 秒，而 d1 实测 17~22 秒，
 * 所以总时长余量只有约 3.6 倍（63s / 17.4s，留 30% 给职业与运气的方差）。
 ...
 */
export const DEPTH_ATK_TARGET: readonly number[] = [1.0, 1.2, 1.45, 1.7, 2.0];
 ...
 */
export const DEPTH_ENCOUNTER_BASE = { hp: 1.25, atk: 1.05 } as const;
