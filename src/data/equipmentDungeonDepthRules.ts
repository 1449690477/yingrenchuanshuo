 ...
 *
 * ── 定稿形状（2026-07-31 批 2-4 P0-2b 反标定后，四职业胜率范围）──
 *   苍蓝 100 / 100 / 99.8~100 / 32~72 / 0~1%
 *   绛紫 100 / 100 / 99.9~100 / 50~90 / 1~12%
 *   赤金 100 / 100 / 95~100   / 20~51 / 0~3%
 *
 ...
 *
 * 批 2-4 已把 d4 档从 1.21 提到 1.24（配合 DEPTH_ENCOUNTER_BASE 反标定），
 * 「赤金系统性偏易一层」的已知残留（docs/72 §5.5 第 3 条：赤金 d4 86%）随
 * A1 威胁因子修平 + 反标定消除，回验落在 20~51% 设计带内（2026-07-31）。
 * 剩余已知残留：d4/d5 的「赢局磨时」（68~82s）具名登记在
 * scripts/equipment-dungeon-balance.mts 的 KNOWN_RESIDUALS（docs/66 §八）。
 */
export const DEPTH_ATK_TARGET: readonly number[] = [1.0, 1.06, 1.13, 1.24, 1.3];
