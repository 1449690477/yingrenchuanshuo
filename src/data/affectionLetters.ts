...
const KENSHI_LETTERS: readonly AffectionLetterDefinition[] = [
  letter(
    'kenshi',
    3,
    '归鞘铃第一次响起以后',
    ...
    [
      [
        'tie_with_permission',
        '你等我扶稳刀鞘、确认位置后才动手。那枚松结到现在仍然刚好。',
        '我喜欢的不是谁替我系好一切，而是有人愿意等我说“现在可以”。',
      ],
      [
        'keep_on_stand',
        '你说被珍惜不等于必须立刻使用。蓝铃在刀架上安静了一整晚。',
        '今天我主动把它系上了。因为这是新的选择，不是昨天未完成的任务。',
      ],
      [
        'ring_after_return',
        '我们约定铃只在归来时响，不催促任何一次出发。这个规则让我很安心。',
        '若你听见它，请知道我已经安全收刀，也正在等一杯不赶时间的茶。',
      ],
    ],
  ),
  letter(
    ...
    6,
    '第二盏灯的使用说明',
    '两枚独立开关被拓印在信纸背面，中间留着一条开放通路。',
    '给拥有自己那盏灯的你：',
    '——守着另一盏灯的樱酱',
    [
      [
        'equal_lanterns',
        '你坚持两盏灯同高、各有开关。我后来才懂，这不是疏远，而是完整的尊重。',
        '今晚我的灯会亮。你的那盏是否点亮，由你决定；欢迎不会因此减少。',
      ],
      [
        'open_doorway',
        '你让门廊中间一直保持畅通。能离开、能独处，反而让我更愿意说“请进”。',
        '道场从来不是锁。它只是一个让我们休息好，再各自出发的地方。',
      ],
      [
        'renew_welcome',
        '我们没有把欢迎设成永久默认，而是每次认真问、认真回答。',
        '所以这是今天的回答：方便，很高兴，而且我为你留了第二杯淡茶。',
      ],
    ],
  ),
  letter(
    ...
    [
      [
        'keep_two_routes',
        '你保留了两条完整路线，没有为了证明亲近而把它们强行合成一条。',
        '正因为我们都能走自己的路，每一次在樱印处相遇才是真正的选择。',
      ],
      [
        'add_rest_stops',
        '你最先标出的不是最快捷径，而是双方都能随时停下的休息站。',
        '第一枚小灯符已经贴在樱川边。若你愿意，下次在那里一起喝午茶。',
      ],
      [
        'renew_each_trip',
        '旧地图被珍藏起来，没有被继续当作今天的命令。那张空白纸让我很喜欢。',
        '下一次出发前，请再和我画一张。路线可以改变，认真询问不会省略。',
      ],
    ],
  ),
  letter(
    ...
    [
      [
        'keep_two_sheaths',
        '两层刀匣仍各自上锁，中央那块养护布却已经留下两种不同的折痕。',
        '我们没有交出全部边界，也没有因此错过共同照顾一件事的机会。',
      ],
      [
        'write_next_return',
        '灯牌没有写永远，只写了明天是否方便。这样的约定比宏大的誓言更让我安心。',
        '我已经写下今天的答案：方便，而且期待。下一行仍留给你自己。',
      ],
      [
        'choose_routes_again',
        '你允许我们保留各自道路，也答应每次相遇都重新选择同行。',
        '我会继续认真练自己的刀、走自己的路，也会认真走向每一个共同确认的会合点。',
      ],
    ],
  ),
];
