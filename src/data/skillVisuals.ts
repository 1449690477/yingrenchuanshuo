...
export const SKILL_VISUALS: Readonly<Record<string, SkillVisualDefinition>> = Object.fromEntries(
  [
    ...
    visual(
      ...
      'assets/effects/kenshi-iai-draw.png',
      'slash',
      'attack',
    ),
    visual(
      'skill_kenshi_sword_heart',
      'assets/icons/skills/kenshi-sword-heart.png',
      'aura',
      'victory',
    ),
    visual(
      'skill_kenshi_wind_thrust',
      'assets/effects/kenshi-wind-thrust.png',
      'dash-impact',
      'dash',
    ),
    visual(
      'skill_kenshi_white_blade',
      'assets/icons/skills/kenshi-white-blade.png',
      'aura',
      'victory',
    ),
    visual(
      'skill_kenshi_sakura_blizzard',
      'assets/effects/kenshi-sakura-blizzard.png',
      'multi-slash',
      'spin',
      [0, 110, 220],
    ),
    visual(
      ...
      'assets/effects/kenshi-armor-break.png',
      'slash',
      'attack',
    ),
    visual(
      'skill_kenshi_sword_intent',
      'assets/icons/skills/kenshi-sword-intent.png',
      'aura',
      'victory',
    ),
    visual(
      'skill_kenshi_iai_flash',
      'assets/effects/kenshi-iai-flash.png',
      'dash-impact',
      'dash',
    ),
    visual(
      'skill_kenshi_sword_storm',
      'assets/effects/kenshi-sword-storm.png',
      'storm',
      'spin',
    ),
    visual(
      'skill_kenshi_swallow_return',
      'assets/effects/kenshi-swallow-return.png',
      'counter',
      'counter',
    ),
    visual(
      'skill_kenshi_no_self',
      'assets/icons/skills/kenshi-no-self.png',
      'aura',
      'victory',
    ),
    visual(
      'skill_kenshi_ice_heart',
      'assets/effects/kenshi-ice-heart.png',
      'multi-slash',
      'cast',
      [0, 180],
    ),
    visual(
      'skill_kenshi_sword_saint',
      'assets/icons/skills/kenshi-sword-saint.png',
      'aura',
      'victory',
    ),
    visual(
      'skill_kenshi_thousand_sakura',
      'assets/effects/kenshi-thousand-sakura.png',
      'ultimate',
      'flurry',
      [0, 75, 150, 225, 300],
    ),
